    ...
    return (
        ...
        <div className="space-y-6 p-10 pb-16">
            ...
            <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
                <aside className="-mx-4 lg:w-1/5 flex flex-col justify-between">
                    <SidebarNav items={user?.isAdmin ? sidebarNavItems : sidebarNavItems.filter(item => item.title !== 'Admin Pannel')} />
                    <div onClick={handleLogout} className='p-2  text-lg rounded-lg bg-primary-foreground  flex items-center gap-4'>
