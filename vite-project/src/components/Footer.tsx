const Footer = () => {
    return (
        <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-3xl md:px-24 lg:px-8">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <div className="flex">
                        ...
                        <a href="mailto:madhavj211@gmail.com" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">madhavj211@gmail.com</a>
                    </div>
                    <div className="flex">
                ...
                <div>
                    ...
                    <div className="flex items-center mt-1 space-x-3">
                        ...
                        <a href="https://www.instagram.com/madhavj212/" className=" transition-colors duration-300 hover:text-deep-purple-accent-400">
